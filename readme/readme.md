...
1. The first container is the **arrow-buttons-container** that contains the previous and next buttons spread in opposite directions at the peripheries of the container. They are used to go to the previous and next slides respectively when clicked on them.
